            ...
            return (
              ...
              >
                <div className="flex items-center gap-3 min-w-0">
                  <div className="flex items-center justify-center w-6">{getRankBadge(index)}</div>
                  ...
                  <div className="flex flex-col min-w-0">
                    <div className="flex items-center gap-1.5">
                      ...
                      {isMe && (
                        <span className="px-1.5 py-0.2 bg-cyan-500/20 text-[10px] text-cyan-300 rounded font-medium">Ты</span>
                      )}
                    </div>
                    {player.username && (
                      <span className="text-[10px] text-slate-500 truncate">@{player.username}</span>
                    )}
                  </div>
                </div>
                ...
                <div className="flex items-center gap-1 shrink-0 pl-2">
                  ...
                  <span className="text-sm font-bold font-mono text-cyan-400">{player.score}</span>
                </div>
              </motion.div>
            );
          })
